...
export const sendBlockAppCommand = (childUid, appPackage, appName) => addDoc(collection(db, 'children', childUid, 'commands'), { type: 'block_app', appPackage, appName, reason: 'Blocked by parent', status: 'pending', createdAt: serverTimestamp() })
export const sendUnblockAppCommand = (childUid, appPackage, appName) => addDoc(collection(db, 'children', childUid, 'commands'), { type: 'unblock_app', appPackage, appName, status: 'pending', createdAt: serverTimestamp() })
export const sendSetLimitCommand = (childUid, appPackage, appName, maxMinutes) => addDoc(collection(db, 'children', childUid, 'commands'), { type: 'set_limit', appPackage, appName, maxMinutes, enabled: true, status: 'pending', createdAt: serverTimestamp() })
